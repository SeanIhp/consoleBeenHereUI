<template>
    <Form :label-width="100" ref="formDialogForm" :rules="form.rules" :model="form.sourceData">
        <Row :gutter="16">
            <Col :span="8" v-for="field in form.fields" :key="field.key">
                <FormItem 
                    :label="field.title" :prop="field.key"
                    v-if="(field.type==undefined || (field.type!='index' && field.type!='selection' && field.type!='expand' && field.type!='html'))">
                        <Input 
                            v-if=" (field.editor===undefined || field.editor==='text' || field.editor==='email')" 
                            :element-id="field.key"
                            type="text" 
                            :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)"
                            v-model="form.sourceData[field.key]"
                            @on-blur="onChange" >
                        </Input>
                        <Input 
                        ...
                        <DatePicker 
                            v-else-if="field.editor==='daterange'" 
                            :element-id="field.key"
                            type="daterange" 
                            format="yyyy-MM-dd"
                            :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)"
                        ...
                        <DatePicker 
                            v-else-if="field.editor==='datetime'" 
                            :element-id="field.key"
                            type="datetime" 
                        ...
                        <DatePicker 
                            v-else-if="field.editor==='datetimerange'" 
                            :element-id="field.key"
                            type="datetimerange" 
                            format="yyyy-MM-dd"
                            :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)"
                        ...
                        <Select 
                            v-else-if="field.editor==='select' && typeof(field.extra)=='string'" 
                            :element-id="field.key"
                            :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)"
                            v-model="form.sourceData[field.key]">
                        ...
                        <Select 
                            v-else-if="field.editor==='select' && typeof(field.extra)=='object'" 
                            :element-id="field.key"
                            :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)"
                            v-model="form.sourceData[field.key]">
                        ...
                        <span v-else-if="field.editor==='demonList'">
                            <Input :element-id="field.key" style="display:inline-block;width:70%;overflow:hidden;" :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)" v-model="form.sourceData[field.key]"/><Button @click="runDemonList(field)" :disabled="disabled?true:(!!field.readonly?((field.readonly=='all' || (field.readonly=='new' && view.toolbar.status.edit=='N') || (field.readonly=='modify' && view.toolbar.status.edit=='E'))?true:false):false)" style="display:inline-block;width:20px;height:31px;padding-left:4px;margin-left:-1px;margin-top:-1px;">...</Button>
                        </span>
                </FormItem>
            </Col>
        </Row>
...
export default {
  ...
  methods: {    
        ...
        runDemonList: function(field){
            ...
            // let opt = {...field.extra};
            let opt = merge([{}, field.extra], {depth: 12, types: { object: true, array: true }});
            opt.refs = this.refs;
  ...
  watch: {
    ...
    'view.dialog.form.sourceData': function(theOne, theOld) {
        console.log("~ ~ ~ ~ ~ ~ ~  view.dialog.form.sourceData： ", theOne);
  ...
  created: function () {
        ...
        //   this.$data.currentRow = this.view.newone;
            this.$data.form = this.view.dialog.form;
            console.log("#########view.list.currentRow!  created ", this);
  },
  updated: function () {
            console.log("FormDialog%%%%bbb@@  updated： ", this);
  },
  handleSubmit (name) {
