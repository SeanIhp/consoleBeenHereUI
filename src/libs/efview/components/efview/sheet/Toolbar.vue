...
export default {
        ...
        //   cmpPager: null,
          config: {
                ...
                [{
                    ...
                    action: function(){
                        _that.checkEditBreaking('N', function(){
                            ...
                            _that.view.list.currentRow = merge([{}, _that.view.newone], {depth: 12, types: { object: true, array: true }});
            ...
            rule: { // 按钮可用规则 Y:已审核, N:录入, C:已取消
                bill: {
                    '#': ['goPrev', 'goNext'],
                    'Y': ['goPrev', 'goNext', 'addData', 'searchData'],
                    'N': ['goPrev', 'goNext', 'addData', 'editData', 'delData', 'searchData'],
                    'C': ['goPrev', 'goNext', 'addData', 'searchData']
                },
                edit: { // 按钮同斥规则 N:新增后, V:查看, E:编辑后, S:保存后, A:审核后, C:取消后, D:删除后(默认) 
                    'N': ['goPrev', 'goNext', 'addData', 'saveData', 'searchData'],
                    'V': ['goPrev', 'goNext', 'addData', 'editData', 'delData', 'searchData'],
                    'E': ['goPrev', 'goNext', 'addData', 'saveData', 'delData', 'searchData'],
                    'S': ['goPrev', 'goNext', 'addData', 'editData', 'delData', 'searchData'],
  ...
  methods: {                               
    ...
    searchData(cb) {
        ...
        let param = merge([{}, this.view.list.searchParam], {depth: 12, types: { object: true, array: true }});
    ...
    synchRowDatas(_flag){          
        ...
        let d = merge([{}, this.view.list.currentRow], {depth: 12, types: { object: true, array: true }});
        if(_flag==="I"){
    ...
    doSave(cb){
        ...
        let param = merge([{}, this.view.list.currentRow], {depth: 12, types: { object: true, array: true }});
